...
void draw() {
  ...
  //stroke(0, 255, 0);
  // horizontal superior
  //line(0, corner_up_left[1], width, corner_up_left[1]);
  // horizontal inferior
  //line(0, corner_bottom_right[1], width, corner_bottom_right[1]);
  // vertical esquerda
  //line(corner_up_left[0], 0, corner_up_left[0], height);
  // vertical direita
  //line(corner_bottom_right[0], 0, corner_bottom_right[0], height);
  //stroke(255, 0, 0);
  // horizontal central
